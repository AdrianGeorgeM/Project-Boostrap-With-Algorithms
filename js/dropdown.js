...
function collectIngredients() {
	for (let i = 0; i < recipes.length; i++) {
		for (let r = 0; r < recipes[i].ingredients.length; r++) {
			if (
				ingredientsList.includes(recipes[i].ingredients[r].ingredient) === false &&
				recipes[i].ingredients[r].ingredient !== ' '
			) {
...
function collectUstensils() {
	for (let i = 0; i < recipes.length; i++) {
		for (let r = 0; r < recipes[i].ustensils.length; r++) {
			if (
				ustensilsList.includes(recipes[i].ustensils[r]) === false &&
				recipes[i].ustensils[r] !== ' '
			) {
